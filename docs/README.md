...
|                      | LFQ                                                            |
| ---------------------|----------------------------------------------------------------|
|                      | FragPipe                           |   Spectronaut    |  Intensity Matrix    |
| ---------------------|-------------------------------------------|----------|---------|
| Quantification Table |combined_proteins.tsv generated by IonQuant|Protein_Report.csv |Protein level intensity matrix|
...
### Example: Needed columns
For the Spectronaut analysis, the columns needed for the quantification matrix are:
PG.ProteinAccessions |PG.Genes|	PG.ProteinDescriptions|	PG.ProteinNames|	PG.Qvalue|	sample1.PG.Quantity|	sample2.PG.Quantity|	sample3.PG.Quantity	|sample4.PG.Quantity|	sample5.PG.Quantity	|sample6.PG.Quantity
